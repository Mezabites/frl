...
{
	[MapSource("frl", "ProjectReportTask")]
	[MapJoin("frl", "Project")]
	...
	public class ProjectReportTaskModel : ProjectTaskModel
	{
		...
		[LabelGroupMark]
		[Show(In.Edit)]
		public override  Link EntriesLink { get; } = Link.ToIndex<ProjectReportTaskEntryController>();
	}
}
